...
data = pd.read_csv("https://raw.githubusercontent.com/PaulAlexInc/streamlit_demo/main/test.csv", index_col='Unnamed: 0',nrows=1000)# Unnamed: 0 is the index column present in the dataset, if its not explicitly mentioned this way, it will also get displayed
